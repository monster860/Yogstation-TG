...
// All logic is handled in tools/stationgen
...
/obj/effect/procedural_marker/turf_check_one
	icon_state = "turf_check_one"
/obj/effect/procedural_marker/maint_node
	icon_state = "maint_node"
