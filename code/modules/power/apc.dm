...
/obj/machinery/power/apc/update_icon()
	...
	if(update & 2)
		...
		if(!(stat & (BROKEN|MAINT)) && update_state & UPSTATE_ALLGOOD)
			SSvis_overlays.add_vis_overlay(src, icon, "apcox-[locked]", layer, FLOAT_PLANE, dir)
			SSvis_overlays.add_vis_overlay(src, icon, "apcox-[locked]", layer, OVERLAY_PLANE(EMISSIVE_PLANE, plane), dir)
			SSvis_overlays.add_vis_overlay(src, icon, "apco3-[charging]", layer, FLOAT_PLANE, dir)
			SSvis_overlays.add_vis_overlay(src, icon, "apco3-[charging]", layer, OVERLAY_PLANE(EMISSIVE_PLANE, plane), dir)
			if(operating)
				SSvis_overlays.add_vis_overlay(src, icon, "apco0-[equipment]", layer, FLOAT_PLANE, dir)
				SSvis_overlays.add_vis_overlay(src, icon, "apco0-[equipment]", layer, OVERLAY_PLANE(EMISSIVE_PLANE, plane), dir)
				SSvis_overlays.add_vis_overlay(src, icon, "apco1-[lighting]", layer, FLOAT_PLANE, dir)
				SSvis_overlays.add_vis_overlay(src, icon, "apco1-[lighting]", layer, OVERLAY_PLANE(EMISSIVE_PLANE, plane), dir)
				SSvis_overlays.add_vis_overlay(src, icon, "apco2-[environ]", layer, FLOAT_PLANE, dir)
				SSvis_overlays.add_vis_overlay(src, icon, "apco2-[environ]", layer, OVERLAY_PLANE(EMISSIVE_PLANE, plane), dir)
